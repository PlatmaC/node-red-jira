...
module.exports = function(RED) {
  function EditIssueNode(config) {
    ...
    node.on('input', async function(msg) {
      ...
      try {
        msg.payload = await apiPut(node.credentials, `/issue/${issue}`, { returnIssue: true }, bodyObject);
  ...
  RED.nodes.registerType("jira-edit-issue", EditIssueNode);
};
